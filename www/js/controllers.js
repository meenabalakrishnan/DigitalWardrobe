...
.controller('HomeController', function($scope) {
	...
	var HOME_ACTION_OUTFITS = {title: "Pick an outfit", icon: "ion-funnel", url:"outfits"};
	var HOME_ACTION_CLOTHING = {title: "Add a clothing to your closet", icon: "ion-ios7-loop-strong", url:"addclothing"};
	var HOME_ACTION_WISHLISTS = {title: "Manage wishlists", icon: "ion-heart", url:"wishlists"};
	...
	$scope.initTimeOfDay = function() {
		...
		$scope.closetActions = [HOME_ACTION_OUTFITS, HOME_ACTION_CLOTHING, HOME_ACTION_WISHLISTS];
	};
